    ...
    <main id="main" class="site-main">
        ...
        <form action="" method="get">
            ...
            <div class="container_filter">
                ...
                ?>
                <div class="container-category-formats flexrow">
                    <div class="filter-category flexcolumn">
                    ...
                    ?>
                    <div class="filter-format flexcolumn ">
...
if ($photo_query->have_posts()) {
    ...
    while ($photo_query->have_posts()) {
        ...
        echo '<div class="photo">'; // Commence un div pour une photo individuelle.
        the_post_thumbnail('medium'); // Affiche la vignette du post avec une taille 'medium'.
        // Ici, vous pouvez ajouter d'autres informations sur le post, comme le titre, l'extrait, etc.
        echo '</div>';
    }
    echo '</div>';
    echo '</div>';
